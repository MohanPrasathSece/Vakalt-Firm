...
const BrandStory = () => {
  return (
    <section className="bg-surface-dark py-28 lg:py-40 overflow-hidden">
      <div className="container mx-auto px-6 lg:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center mb-24 lg:mb-32">
          <ScrollReveal>
            <p className="text-sans text-label uppercase text-surface-charcoal-foreground/50 mb-6">Our Philosophy</p>
            <div className="text-serif text-5xl lg:text-7xl font-bold text-surface-dark-foreground leading-tight">
          ...
          <ScrollReveal delay={0.15}>
            <p className="text-sans text-body-lg text-surface-charcoal-foreground/70 leading-relaxed">
            ...
            <p className="text-sans text-body text-surface-charcoal-foreground/50 leading-relaxed mt-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-px">
          {values.map((v, i) => (
            <ScrollReveal key={v.title} delay={i * 0.1}>
              <div className="bg-surface-charcoal p-10 lg:p-14 group hover:bg-surface-charcoal/80 transition-colors duration-500">
                <v.icon className="w-6 h-6 text-surface-charcoal-foreground/40 mb-8 group-hover:text-surface-dark-foreground transition-colors duration-500" />
                <h3 className="text-serif text-subheading font-semibold text-surface-dark-foreground mb-4">
                  {v.title}
                </h3>
                <p className="text-sans text-body text-surface-charcoal-foreground/60">
                  {v.desc}
                </p>
              </div>
            </ScrollReveal>
